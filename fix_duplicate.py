...
def main():
    ...
    # Check if Card 1 and Card 2 have the same title
    if 'Israel e Irã' in cards[0] and 'Israel e Irã' in cards[1]:
        print("Duplicate found! Removing Card 2...")
        cards.pop(1)

    # Let's add Monique Medeiros back if we have less than 6 cards
    monique_card = """
...
"""
    ...
    print("Cards duplicated removed and fixed successfully!")
